import { ArrowRight, CreditCard, Shield, Building2, MessageSquare } from "lucide-react";
        ...
        <div className="banner-overlay bg-transparent pt-20 sm:pt-24 md:pt-32 w-full">
          <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
            <motion.div className="w-full max-w-4xl text-center" variants={itemVariants}>
              <motion.h1 className="banner-title text-white" variants={itemVariants}>HubBank: Solução Completa de Banking White Label</motion.h1>
              <motion.p className="banner-subtitle text-gray-300 mt-4 sm:mt-6" variants={itemVariants}>
                A plataforma de banking digital perfeita para grandes companhias que desejam oferecer serviços financeiros sob sua própria marca.
              </motion.p>
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        delay: 0.6
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-gray-800">Banking Completo</h3>
            <p className="text-gray-600 text-xs md:text-sm">Plataforma completa com contas, cartões, PIX, TED, DOC e todos os serviços bancários.</p>
          </motion.div>
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-gray-800">Segurança Total</h3>
            <p className="text-gray-600 text-xs md:text-sm">Conformidade PCI-DSS, Open Banking e todas as regulamentações do Banco Central.</p>
          </motion.div>
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-gray-800">White Label</h3>
            <p className="text-gray-600 text-xs md:text-sm">Solução totalmente personalizável com sua marca para grandes corporações.</p>
          </motion.div>
        </motion.div>
      </div>
    </motion.div>;
